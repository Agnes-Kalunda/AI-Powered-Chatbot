...
def generate_openai_response(message):
    try:
        openai_response = openai.ChatCompletion.create(
            model="gpt-3.5-turbo",
            messages=[
                {"role": "system", "content": "You are an AI Assistant called AggieBot, created by Agnes to only answer programming questions. Any  information regarding Agnes they can directly ask her Via +254 707606316."},
